...
copcarshop1 addAction["Vehicle Garage",{
	[getPlayerUID player,"cop","Car",player] remoteExecCall ["TON_fnc_getVehicles",2];
	createDialog "Life_impound_menu";
	disableSerialization;
	ctrlSetText[2802,"Fetching Vehicles...."];
	life_garage_sp = "kavala_cop_car_1"; life_garage_type = "Car";
},"",0,false,false,"",'',5];
...
copcarshop2 addAction["Vehicle Garage",{
	[getPlayerUID player,"cop","Car",player] remoteExecCall ["TON_fnc_getVehicles",2];
	createDialog "Life_impound_menu";
	disableSerialization;
	ctrlSetText[2802,"Fetching Vehicles...."];
	life_garage_sp = "cop_car_2"; life_garage_type = "Car";
},"",0,false,false,"",'',5];
...
copcarshop3 addAction["Vehicle Garage",{
	[getPlayerUID player,"cop","Car",player] remoteExecCall ["TON_fnc_getVehicles",2];
	createDialog "Life_impound_menu";
	disableSerialization;
	ctrlSetText[2802,"Fetching Vehicles...."];
	life_garage_sp = "cop_car_3"; life_garage_type = "Car";
},"",0,false,false,"",'',5];
...
copcarshop4 addAction["Vehicle Garage",{
	[getPlayerUID player,"cop","Car",player] remoteExecCall ["TON_fnc_getVehicles",2];
	createDialog "Life_impound_menu";
	disableSerialization;
	ctrlSetText[2802,"Fetching Vehicles...."];
	life_garage_sp = "cop_car_5"; life_garage_type = "Car";
},"",0,false,false,"",'',5];
...
processcocaine1 addAction["Process Cocaine",life_fnc_processAction,"cocaine",0,false,false,"",' life_inv_cocaine_unprocessed > 0 && !life_is_processing',5];
...
processcopper1 addAction["Process Copper",life_fnc_processAction,"copper",0,false,false,"",' life_inv_copper_unrefined > 0 && !life_is_processing',5];
...
processdiamond1 addAction["Process Diamond",life_fnc_processAction,"diamond",0,false,false,"",' life_inv_diamond_uncut > 0 && !life_is_processing',5];
...
processheroin1 addAction["Process Heroin",life_fnc_processAction,"heroin",0,false,false,"",' life_inv_heroin_unprocessed > 0 && !life_is_processing',5];
...
processiron1 addAction["Process Iron",life_fnc_processAction,"iron",0,false,false,"",' life_inv_iron_unrefined > 0 && !life_is_processing',5];
...
processoil1 addAction["Process Oil",life_fnc_processAction,"oil",0,false,false,"",' life_inv_oil_unprocessed > 0 && !life_is_processing',5];
...
processrock1 addAction["Process Rock",life_fnc_processAction,"cement",0,false,false,"",' life_inv_rock > 0 && !life_is_processing',5];
...
processsalt1 addAction["Process Salt",life_fnc_processAction,"salt",0,false,false,"",' life_inv_salt_unrefined > 0 && !life_is_processing',5];
...
processsand1 addAction["Process Sand",life_fnc_processAction,"sand",0,false,false,"",' life_inv_sand > 0 && !life_is_processing',5];
...
processmarijuana1 addAction["Process Marijuana",life_fnc_processAction,"marijuana",0,false,false,"",' life_inv_cannabis > 0 && !life_is_processing',5];
...
airgarage_airport addAction["Vehicle Garage",{
	[getPlayerUID player,"civ","Air",player] remoteExecCall ["TON_fnc_getVehicles",2];
...
copairshop1 addAction["Vehicle Garage",{
	[getPlayerUID player,"cop","Air",player] remoteExecCall ["TON_fnc_getVehicles",2];
	createDialog "Life_impound_menu";
	disableSerialization;
	ctrlSetText[2802,"Fetching Vehicles...."];
...
copairshop2 addAction["Vehicle Garage",{
	[getPlayerUID player,"cop","Air",player] remoteExecCall ["TON_fnc_getVehicles",2];
	createDialog "Life_impound_menu";
	disableSerialization;
	ctrlSetText[2802,"Fetching Vehicles...."];
	life_garage_sp = "cop_air_2"; life_garage_type = "Air";
},"",0,false,false,"",'',5];
...
_boatshops = [copboatshop1,boatshop1,boatshop2];
{
	...
	copboatshop1 addAction["Vehicle Garage",{
	[getPlayerUID player,"cop","Ship",player] remoteExecCall ["TON_fnc_getVehicles",2];
	createDialog "Life_impound_menu";
	disableSerialization;
	ctrlSetText[2802,"Fetching Vehicles...."];
	life_garage_sp = "cop_ship_1"; life_garage_type = "Ship";
	},"",0,false,false,"",'',5];
	...
	boatshop1 addAction["Vehicle Garage",{
	[getPlayerUID player,playerSide,"Ship",player] remoteExecCall ["TON_fnc_getVehicles",2];
	createDialog "Life_impound_menu";
	disableSerialization;
	ctrlSetText[2802,"Fetching Vehicles...."];
	life_garage_sp = "civ_ship_1"; life_garage_type = "Ship";
	},"",0,false,false,"",'playerSide == civilian',5];
	...
	boatshop2 addAction["Vehicle Garage",{
	[getPlayerUID player,playerSide,"Ship",player] remoteExecCall ["TON_fnc_getVehicles",2];
	createDialog "Life_impound_menu";
	disableSerialization;
	ctrlSetText[2802,"Fetching Vehicles...."];
	life_garage_sp = "civ_ship_2"; life_garage_type = "Ship";
},"",0,false,false,"",'playerSide == civilian',5];
...
_copshops = [h1_3,h1_3_1,h1_3_2,h1_3_3];
{
	...
	_x addAction["Cop Patrol Weapon Shop",life_fnc_weaponShopMenu,"cop_patrol",1.5,true,true,"","true",5];  
	_x addAction["Cop Sergeant Weapon Shop",life_fnc_weaponShopMenu,"cop_sergeant",1.5,true,true,"","true",5];
...
medicshop1 addAction["Car Garage",{
	[getPlayerUID player,"med","Car",player] remoteExecCall ["TON_fnc_getVehicles",2];
	createDialog "Life_impound_menu";
	disableSerialization;
	ctrlSetText[2802,"Fetching Vehicles...."];
	life_garage_sp = "med_car_3"; life_garage_type = "Car";
},"",0,false,false,"",'',5];
medicshop1 addAction["Helicopter Garage",{
	[getPlayerUID player,"med","Air",player] remoteExecCall ["TON_fnc_getVehicles",2];
	createDialog "Life_impound_menu";
	disableSerialization;
	ctrlSetText[2802,"Fetching Vehicles...."];
	life_garage_sp = "medic_spawn_2"; life_garage_type = "Air";
},"",0,false,false,"",'',5];
...
medicshop2 addAction["Car Garage",{
	[getPlayerUID player,"med","Car",player] remoteExecCall ["TON_fnc_getVehicles",2];
	createDialog "Life_impound_menu";
	disableSerialization;
	ctrlSetText[2802,"Fetching Vehicles...."];
	life_garage_sp = "med_car_2"; life_garage_type = "Car";
},"",0,false,false,"",'',5];
medicshop2 addAction["Helicopter Garage",{
	[getPlayerUID player,"med","Air",player] remoteExecCall ["TON_fnc_getVehicles",2];
	createDialog "Life_impound_menu";
	disableSerialization;
	ctrlSetText[2802,"Fetching Vehicles...."];
	life_garage_sp = "medic_spawn_3"; life_garage_type = "Air";
},"",0,false,false,"",'',5];
...
medicshop3 addAction["Car Garage",{
	[getPlayerUID player,"med","Car",player] remoteExecCall ["TON_fnc_getVehicles",2];
	createDialog "Life_impound_menu";
	disableSerialization;
	ctrlSetText[2802,"Fetching Vehicles...."];
...
medicshop3 addAction["Helicopter Garage",{
	[getPlayerUID player,"med","Air",player] remoteExecCall ["TON_fnc_getVehicles",2];
	createDialog "Life_impound_menu";
	disableSerialization;
	ctrlSetText[2802,"Fetching Vehicles...."];
...
_rebelshops = [reb_1,reb_1_1,reb_1_2];
{
	...
	_x addAction["Rebel Clothing Shop",life_fnc_clothingMenu,"reb",0,false,false,"",' license_rebel && playerSide == civilian',5];
	_x addAction["Rebel Weapon Shop",life_fnc_weaponShopMenu,"rebel",0,false,false,"",' license_rebel && playerSide == civilian',5];
...
reb_1_3 addAction["Vehicle Shop",life_fnc_vehicleShopMenu,["reb_car",civilian,["reb_v_1","reb_v_1_1"],"civ","Rebel Motorpool - Western Side"],0,false,false,"",'license_rebel',5];
reb_1_3 addAction["Vehicle Garage",{
	[getPlayerUID player,playerSide,"Car",player] remoteExecCall ["TON_fnc_getVehicles",2];
	life_garage_type = "Car"; createDialog "Life_impound_menu";
	disableSerialization;
	ctrlSetText[2802,"Fetching Vehicles...."];
	life_garage_sp = "reb_v_1";
},"",1.5,true,true,"","true",5];
reb_1_3_1 addAction["Vehicle Shop",life_fnc_vehicleShopMenu,["reb_car",civilian,"reb_v_2","civ","Rebel Motorpool - Western Side"],0,false,false,"",'license_rebel',5];
reb_1_3_1 addAction["Vehicle Garage",{
	[getPlayerUID player,playerSide,"Car",player] remoteExecCall ["TON_fnc_getVehicles",2];
	life_garage_type = "Car"; createDialog "Life_impound_menu";
	disableSerialization;
	ctrlSetText[2802,"Fetching Vehicles...."];
	life_garage_sp = "reb_v_2";
},"",1.5,true,true,"","true",5];
